...
\label{sec:design_and_implementation}
	...
	\label{sub:sparsity_estimation}
		...
		When \texttt{snake} is set to \texttt{true}, enabling the use of the snake pattern, the amount of harmonic overtones present is greatly reduced, as seen in Figure \fxnote{Insert figure}.
